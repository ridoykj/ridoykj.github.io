    ...
    const CardData = ({ data }: { data: CardDataProps }) => {
        return (
            <div className='flex flex-col gap-4 items-center text-center'>
                <div className='group bg-violet-50 p-3 rounded-3xl flex flex-col items-center hover:bg-violet-900 size-full'>
